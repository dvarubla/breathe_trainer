...
namespace breathe_trainer{
    ProfileWithNameVect Settings::DEFAULT_SETTINGS = {
            {
                    {{4, 0, 0, 0}, {4, 0, 0, 0}, {4, 0, 0, 0}, {4, 0, 0, 0}, 3, 1, 3, 0, 3, 0},
                    "Начальный"
            },
            {
                    {{4, 0, 0, 0}, {8, 0, 0, 0}, {8, 0, 0, 0}, {8, 0, 0, 0}, 4, 2, 4, 0, 6, 0},
                    "Средний"
            },
            {
                    {{5, 2, 1, 1}, {10, 2, 1, 1}, {10, 2, 1, 1}, {10, 2, 1, 1}, 5, 3, 5, 5, 5, 5},
                    "Высокий"
            },
            {
                    {{6, 0, 0, 0}, {12, 0, 0, 0}, {12, 0, 0, 0}, {12, 0, 0, 0}, 5, 3, 5, 5, 5, 5},
                    "Супер"
            }
    };
